...
def diagnostico():
    ...
    if (ubicacion_laptop  == 'D'):
        ...
        if (estado == '0'): #Caso de la parte D este en mal estado
        ...
        elif (estado == '1'): #El dignostico del disco (D) esta en mal estado
        ...
        if(estado == '1'): #El dignostico del disco (B) esta en mal estado
            print("El diagnostico reporta un mal estado")
        ...
        elif (estado == '0'): #Caso de la parte P este en mal estado
            print("El diagnostico de B se encuentra en buen estado")
            if(ubicacion2_estado == '1'):
                print("El diagnostico de D esta en mal estado")
                print("El diagnostico empezara ahora en D") 
                costo += 1 #Cada vez que el diagnostico este en buen estado aumentara
    ...
    elif (ubicacion_laptop  == 'P'):
        ubicacion2_estado = input("Ingrese el estado de D") # Se indica si esta de estado 0/1 en dicha ubicacion.
        ubicacion3_estado = input("Ingrese el estado de B") # Se indica si esta de estado 0/1 en dicha ubicacion.
        print("Objetivo:" + str(objetivo)) #Los objetivos esperados por el agente
        print("La ubicacion del diagnostico se encuentra en P")# Ubicacion del diagnostico
        
        if(estado == '1'): #El dignostico del disco (P) esta en mal estado
            print("El diagnostico reporta un mal estado")
            objetivo['P'] ='0' #Diagnostico pasara a 0
            costo += 1 #Aumenta el costo
            print("El diagnostico reporta buen estado en el P")
            print("El costo actual es: " +str(costo)) 
        ...
        elif (estado == '0'): #Caso de la parte D este en mal estado
            print("El diagnostico de P se encuentra en buen estado")
            if(ubicacion2_estado == '1'):
                print("El diagnostico de D esta en mal estado")
                print("El diagnostico empezara ahora en D") 
            ...
            #El estado ingresado esta fuera del rango
            print("Su estado ingresaso esta erroneo, digite de nuevo")

    #Todo Encendido
    print("Estado Objetivo: " + str(objetivo))
